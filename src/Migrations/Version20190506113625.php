 ...
 */
final class Version20190506113625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE therapist (id INT AUTO_INCREMENT NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, upload_date DATETIME NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, archived TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_8C9F36106B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient_incident (id INT AUTO_INCREMENT NOT NULL, file_detail_id INT NOT NULL, date DATETIME NOT NULL, longitude DOUBLE PRECISION DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, progress SMALLINT DEFAULT NULL, scale_value SMALLINT DEFAULT NULL, INDEX IDX_A86F9BF56DFBCCD (file_detail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, therapist_id INT NOT NULL, addiction_name VARCHAR(255) DEFAULT NULL, archived TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_1ADAD7EB217BBB47 (person_id), INDEX IDX_1ADAD7EB43E8B094 (therapist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
